...
int main() {
    ...
    // Generating secrets.
    a1 = rand() % 5000 + 2; //Red::Randomize() % 7000000 + 1; //Randomizer is in RedLibrary, a (E [1; 7000001]. Warning: Takes a lot of time to calculate.
    a2 = 5;

    b1 = 126;
    b2 = 20;

    Red::TwoLayerDiffieHellman<Red::uint65536_t> Alice(&P, &a1, &a2, RED_2lDH_1543m_AUTO);
    Red::TwoLayerDiffieHellman<Red::uint65536_t> Bob(&P, &b1, &b2);
    ...
    std::cout << "Pb: " << *Pb << std::endl << std::endl << std::endl;
